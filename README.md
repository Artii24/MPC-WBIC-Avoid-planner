...
Для запуска со зрением использовать инструкцию в [репозитории](https://gitlab.com/beerlab/unitree_a1/elevation_map/-/tree/develop)
...
Оригинальная реализация контроллера находится в папке [convexMPC](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/controllers/convexMPC). Так как мы меняли некоторые части контроллера, сделали копию этой папки и назвали CMPC.  
...
# WBC
Реализация режит в папках [WBC](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/controllers/WBC) и [WBC_Ctrl](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/controllers/WBC_Ctrl).
...
Реализация находится в файле [FootSwingTrajectory](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/common/Controllers)  
...
# Leg Controller
Реализация находится в файле [LegController](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/common/Controllers)  
...
# Body Manager
Реализация находится в файле [be2r_cmpc_unitree](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/be2r_cmpc_unitree)  
...
# Параметризация
Все динамические и кинематические параметры робота хранятся в файле [MiniCheetah.h](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/common/Dynamics). Все параметры взяты из официального URDF файла репозитория Unitree на github.

# Odometry (Position and Orientation estimators)
Реализация находится в файле [PositionVelocityEstimator](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/common/Controllers) и [OrientationEstimator](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/common/Controllers)  
...
# Debug
Реализация находится в папке [debug](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/common/debug).  
...
Реализация находится в папке [fsm](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/fsm). Там же находится описание всех состояний. У каждого состояния своя папка.  
...
# Gait scheduler
Есть две реализации: [GaitScheduler](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/common/Controllers) и [Gait](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/controllers/convexMPC) (либо его копия в [Gait_Contact](https://gitlab.com/beerlab/unitree_a1/be2r_cmpc_unitree/-/tree/main/src/controllers/CMPC)) [deprecated]. Используется в коде только версия Gait.  
